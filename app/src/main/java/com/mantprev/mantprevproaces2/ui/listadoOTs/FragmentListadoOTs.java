...
import com.mantprev.mantprevproaces2.databinding.FragmentListadoOtsBinding;
...
public class FragmentListadoOTs extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = FragmentListadoOtsBinding.inflate(inflater, container, false);
    ...
    /****************************/
        ...
        mostrarListadoGralOTs(fechaInic, fechaFinal);
    }
    ...
    private void mostrarListadoGralOTs(String fechaInic, String fechaFinal){
    /********************************************************************/
        progressBar.setVisibility(View.VISIBLE);

        DataServices_Intf service = Retrofit_Instance.getRetrofitInstance().create(DataServices_Intf.class);
        Call<List<OrdenesTrabajo>> listaOTs = null;

        listaOTs = service.getListOTsByFechas(fechaInic, fechaFinal);
